...
print(paste("95% CI:", round(asr_result_who$ci_lower_scaled, 2), "-", round(asr_result_who$ci_upper_scaled, 2)))
...
print(paste("95% CI:", round(asr_result_10yr$ci_lower_scaled, 2), "-", round(asr_result_10yr$ci_upper_scaled, 2)))
...
print(paste("95% CI:", round(diabetes_prevalence$ci_lower_scaled, 2), "% -", 
            round(diabetes_prevalence$ci_upper_scaled, 2), "%"))
